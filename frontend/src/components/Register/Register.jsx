...
export default function Register(){
    ...
    const validations=yup.object().shape({
        ...
        phonenumber:yup.string().required('phone number required').min(10,'Not valid phone number').max(10,'Not valid phone number').matches(/^((\\+[1-9]{1,4}[ \\-]*)|(\\([0-9]{2,3}\\)[ \\-]*)|([0-9]{2,4})[ \\-]*)*?[0-9]{3,4}?[ \\-]*[0-9]{3,4}?$/,'Not a valid phonne number'),
        ...
        email:yup.string().required('email is required').email('Inavalid email format').notOneOf(emails,'Email already Taken!')     
